from BCD.Hadamard_BCD import *
from BCD.Hadamard_BCD_multiple import BCD_multiple
...
def load_dataset(dataset_name, m=100, n=100, h=35):
    ...
    if dataset_name == "olivetti":
        ...
        with open("BCD/datasets/lrs.data") as inp:
        ...
        G = nx.read_gml('BCD/datasets/football.gml')
        D = nx.to_numpy_array(G)

    elif dataset_name == "miserables":
        G = nx.read_gml('BCD/datasets/lesmis.gml')
        D = nx.to_numpy_array(G)
